...
def connect_os_gdf():
    ...
    os_connected_gdf = OSRoadsNetworkBuilder(0).build_road_network_gdf(os_converted_gdf)
...
if __name__ == "__main__":
    ...
    # os_original_path = parent_directory_at_level(__file__, 4) + "/Operational_Data/temp/OS_roads.shp"
    # os_converted_path = parent_directory_at_level(__file__,4) + "/Operational_Data/temp/OS_roads_converted.shp"
    # os_gdf = gpd.read_file(os_converted_path)
    # print(os_gdf)
    # os_connected_gdf = OSRoadsNetworkBuilder(0).build_road_network_gdf(os_gdf)
